...
public class healthDisplay : MonoBehaviour {
	...
	void OnGUI() {
		GUI.Label (new Rect(10, 10, 300, 300), p1.playerHealth.health.ToString(), labelFontSize);
		GUI.Label (new Rect(1200, 10, 300, 300), p2.playerHealth.health.ToString(), labelFontSize);
	}
}
